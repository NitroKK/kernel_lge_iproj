...
#if 1
#define MSM_PMEM_KERNEL_EBI1_SIZE  0x600000   /* 6MB */
#define MSM_PMEM_ADSP_SIZE         0x2000000  /* 32MB */
#define MSM_PMEM_AUDIO_SIZE        0x28B000   /* 2,5MB */
//#define MSM_PMEM_AUDIO_SIZE        0x4CF000 /* 5MB */

#define MSM_SMI_BASE          0x38000000 /* 896MB */
#define MSM_SMI_SIZE          0x4000000 /* 64MB */

#define KERNEL_SMI_BASE       (MSM_SMI_BASE)
#define KERNEL_SMI_SIZE       0x600000 /* 6MB */
